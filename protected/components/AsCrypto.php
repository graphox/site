...
#
# Version 0.3 / genuine Alphaserv port
#
...
class AsCrypto extends CComponent
{
	...
	public function checkUserPassword(&$model, &$form)
	{
	...
	{
		if ($this->iteration_count_log2 < 4 || $this->iteration_count_log2 > 31)
