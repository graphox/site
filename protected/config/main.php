...
#'errorAction'=>'site/error',
     ...
     *
     * end users please do not change!
     */
    'container' => array(
        'timeline.renderManager.class' => 'Graphox\Timeline\RenderManager',
        'timeline.renderManager' => function($c)
        {
            static $instance;

            if (!isset($instance))
            {
                $instance = new $c['timeline.renderManager.class']($c['render.renderManager']);
            }

            return $instance;
        },
        'render.renderManager.class' => 'Graphox\Render\RenderManager',
        'render.renderManager' => function($c)
        {
            static $instance;

            if (!isset($instance))
            {
                $instance = new $c['render.renderManager.class'];
            }
