...
<?php $container->start_tab('info'); ?><h2>Menu Items Management</h2>
<p>
...
<fieldset>
	<label>url</label>
	<?=CHtml::textField('search[url]', (isset($_POST['search']) && isset($_POST['search']['url'])) ? $_POST['search']['url'] : '')?></fieldset>
<fieldset>
...
<?php $container->start_tab('Add Menu Items'); ?>
...
<article class="module width_full">
	<header>
		<h3 class="tabs_involved">Menu Items Manager</h3>
	...
	<div class="module_content" style="margin:0">
		<table class="tablesorter" cellspacing="0">			<thead>
				<tr>
					...
					<th class="header"><?=CHtml::link('url', array('', 'order-by' => 'url'))?></th>
