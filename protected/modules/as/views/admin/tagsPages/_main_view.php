...
<?php $container->start_tab('info'); ?><h2>Tags Pages Management</h2>
<p>
...
<fieldset>
	<label>tag_id</label>
	<?=CHtml::textField('search[tag_id]', (isset($_POST['search']) && isset($_POST['search']['tag_id'])) ? $_POST['search']['tag_id'] : '')?></fieldset>
<fieldset>
	<label>page_id</label>
...
<?php $container->start_tab('Add Tags Pages'); ?>
...
<article class="module width_full">
	<header>
		<h3 class="tabs_involved">Tags Pages Manager</h3>
	...
	<div class="module_content" style="margin:0">
		<table class="tablesorter" cellspacing="0">			<thead>
				<tr>
					...
					<th class="header"><?=CHtml::link('tag id', array('', 'order-by' => 'tag_id'))?></th>
