...
<?php $container->start_tab('info'); ?><h2>Tags Management</h2>
<p>
...
<fieldset>
	<label>tag</label>
	<?=CHtml::textField('search[tag]', (isset($_POST['search']) && isset($_POST['search']['tag'])) ? $_POST['search']['tag'] : '')?></fieldset>
<footer>
...
<?php $container->start_tab('Add Tags'); ?>
...
<article class="module width_full">
	<header>
		<h3 class="tabs_involved">Tags Manager</h3>
	...
	<div class="module_content" style="margin:0">
		<table class="tablesorter" cellspacing="0">			<thead>
				<tr>
					...
					<th class="header"><?=CHtml::link('tag', array('', 'order-by' => 'tag'))?></th>
