...
<?php $container->start_tab('info'); ?><h2>Clan Members Management</h2>
<p>
...
<fieldset>
	<label>rank_id</label>
	<?=CHtml::textField('search[rank_id]', (isset($_POST['search']) && isset($_POST['search']['rank_id'])) ? $_POST['search']['rank_id'] : '')?></fieldset>
<footer>
...
<?php $container->start_tab('Add Clan Members'); ?>
...
<article class="module width_full">
	<header>
		<h3 class="tabs_involved">Clan Members Manager</h3>
	...
	<div class="module_content" style="margin:0">
		<table class="tablesorter" cellspacing="0">			<thead>
				<tr>
					...
					<th class="header"><?=CHtml::link('rank id', array('', 'order-by' => 'rank_id'))?></th>
