...
<?php $container->start_tab('info'); ?><h2>Pm Directories Management</h2>
<p>
...
<?php $container->start_tab('Add Pm Directories'); ?>
...
<article class="module width_full">
	<header>
		<h3 class="tabs_involved">Pm Directories Manager</h3>
