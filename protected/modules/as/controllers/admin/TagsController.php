...
class TagsController extends AdminController
{
	...
	public function actionIndex()
	{
		$this->breadcrumbs = array(
			array('Tags', array('index')),
			array('Overview', '', array('class' => 'active'))
		);
		
		if((($access = AccessControl::GetAccess('Tags::Overview')) === false) || $access->read != 1)
			$this->denyAccess();
	...
	{
		if((($access = AccessControl::GetAccess('Tags::Overview')) === false) || $access->delete != 1)
			$this->denyAccess();
	...
	{
		if((($access = AccessControl::GetAccess('Tags::Overview')) === false) || $access->write != 1)
			$this->denyAccess();
	...
	{
		if((($access = AccessControl::GetAccess('Tags::Overview')) === false) || $access->update != 1)
			$this->denyAccess();
