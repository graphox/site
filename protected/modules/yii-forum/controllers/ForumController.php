...
*/
    ...
    public function actionIndex()
    {
        ...
        $this->render('index',array(
            'categories'=>Forum::model()->findAll(),
        ));
    }
    ...
    public function actionView($id)
    {
        ...
        $subforumsProvider = new CArrayDataProvider($forum->subForums, array(
            'pagination'=>false,
        ));

        $threadsProvider = new CArrayDataProvider($forum->threads, array(
            'pagination'=>array(
    ...
    {
        $forum=new Forum;
		$parentid == null or $forum->parentId=$parentid;
    ...
    public function actionUpdate($id)
    {
        ...
        if(isset($_POST['Forum']))
        {
            ...
            if($forum->validate())
            {
                if((int)$forum->parentId < 1) $forum->parentId = null;
                $forum->save();
                $this->redirect($forum->url);
            }
        }
