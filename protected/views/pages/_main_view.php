			...
			<table class="tablesorter" cellspacing="0">				<thead>
				...
				<tbody>
					<?php foreach($models as $row): ?>						<tr data-selectedrow="0">
							...
							<?php #controls ?>
							<td class="controls">
								<input type="image" src="<?=Yii::app()->theme->baseUrl?>/images/icn_search.png" title="Inspect" />
								<input type="image" src="<?=Yii::app()->theme->baseUrl?>/images/icn_edit.png" title="Edit" />
								<input type="image" src="<?=Yii::app()->theme->baseUrl?>/images/icn_trash.png" title="Trash" />
							</td>
						</tr>
