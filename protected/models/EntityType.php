 ...
 * @property EntityTypeActions[] $entityTypeActions
 */
class EntityType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'entities' => array(self::HAS_MANY, 'Entity', 'subtype_id'),
			'entityTypeActions' => array(self::HAS_MANY, 'EntityTypeAction', 'entity_type_id'),
		);
	}
